 ...
 *  @link		   http://www.area80.net
 *  @usage         import net.area80.debug.FPS;
...
package net.area80.debug {
	...
	public class FPS extends Sprite	{
		...
		*/
		public static const AUTHOR  :String = '(c) 2006-2008 Copyright by Wissarut Pimanmassuriya | area80.net | wissarut@area80.net';
		...
		*/
		...
		public static function tostring ():String {
			return "net.area80.debug.FPS, version:"+VERSION;
		}
		...
		****************************************************/
		...
		private function createRollOverText ():void {
				...
				tField.text = "FPS Monitor by Area80.net";
		...
		private function initMouseEvents ():void {
				...
				var mcEnterFrame:Function = function (e:Event):void {
		...
		private function set isExpand (b:Boolean):void {
				_isExpand = b;
				if(b){
					WIDTH = 200;
					HEIGHT = 120;
		...
		private function drawData ():void {
			...
			if(isExpand){
				TEXTFIELD.text = "FPS : "+currentFPS+"/ TE : "+timeElapsed+" ms./ MemUse : "+Math.round(currentMemory*0.000001)+" mb.";
			} else {
				TEXTFIELD.text = "F.T.M   "+currentFPS+"/ "+timeElapsed+"/ "+Math.round(currentMemory*0.000001) ;
			}
			if(parent == root) {
				if (align == FPS.ALIGN_LEFT) {
